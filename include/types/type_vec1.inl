...
namespace smath {
	...
	template<class T>
	SMATH_CONSTEXPR vec<1, T>::vec()
		: x{}
	{}

	template<class T>
	SMATH_CONSTEXPR vec<1, T>::vec(T scalar)
		: x(scalar)
	{}

	template<class T>
	template<class A>
	SMATH_CONSTEXPR vec<1, T>::vec(A _x)
		: x(static_cast<T>(_x))
	{}

	template<class T>
	SMATH_CONSTEXPR vec<1, T>::vec(const vec<1, T> &v)
		: x(v.x)
	{}

	template<class T>
	template<class A>
	SMATH_CONSTEXPR vec<1, T>::vec(const vec<1, A> &v)
		: x(static_cast<T>(v.x))
	{}
	...
	template<class T>
	SMATH_CONSTEXPR T& vec<1, T>::operator[](int i) {
	...
	template<class T>
	SMATH_CONSTEXPR const T& vec<1, T>::operator[](int i) const {
		assert(i >= 0 && i < this->size());
		switch(i) {
			default:
			case 0:
	...
	template<class T>
	template<class A>
	SMATH_CONSTEXPR vec<1, T>& vec<1, T>::operator=(const vec<1, A> &v) {
	...
	template<class T>
	template<class A>
	SMATH_CONSTEXPR vec<1, T>& vec<1, T>::operator+=(A scalar) {
	...
	template<class T>
	SMATH_CONSTEXPR vec<1, T>& vec<1, T>::operator++() {
	...
	template<class T>
	SMATH_CONSTEXPR vec<1, T> vec<1, T>::operator++(int) {
